    ...
    >
      ...
      <div className="flex items-center justify-end space-x-2 w-full">
        <div className="flex items-center gap-4">
          ...
          >
            <span className="ml-2 text-type-600 text-sm text-opacity-40 ps-2 pointer-events-none">
              Plugins
            </span>
          </a>
          <WalletMultiButtonDynamic
            className={cn(
              ...
              "bg-type-alt-500 text-black hover:bg-type-alt-700 hover:text-black font-gabarito"
            )}
          />
          {wallet.publicKey && <></>}
        </div>
