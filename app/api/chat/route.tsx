...
//     const fetchsolanaWalletDetail = new DynamicStructuredTool({
...
//         console.log('vsCurrency:', vsCurrency);
...
//       description:
//         'Fetches the the details about a spcific Solana Wallet Address',
//       schema: z.object({
//         address: z.any()
//         // vsCurrency: z.string().optional().default("USD"),
//       }),
...
//     console.log('returnIntermediateSteps');
//     console.log(returnIntermediateSteps);
