...
const exampleMessages = [
  {
    heading: "i want to swap 3usdc to usdt?",
    message: "i want to swap 3usdc to usdt?",
  },
  {
    heading: "swap 0.1sol to usdt?",
    message: "i want to swap 0.1sol to usdt?",
  },
  {
...
export function EmptyScreenSwap({
  submitMessage,
}: {
      ...
      <div className="py-16">
        <div className="mb-6">
          ...
          <p className="font-normal text-sm leading-normal text-type-600 text-opacity-50">
            You can start a swap here or try the following examples:
          </p>
        </div>
